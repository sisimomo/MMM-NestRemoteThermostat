...
| `targetTemperaturePrecision`	| Set the level of precision for display of the target temperature.  E.g., `.5` will round to the nearest half degree, and `1` will reound to the nearest degree. (You can set any number you want, but only one decimal place will be displayed at most.)<br><br> **Type:** `Float` <br>**Default value:** `.5`
| `ambientTemperaturePrecision`	| Set the level of precision for display of the target temperature.  E.g., `.5` will round to the nearest half degree, and `1` will reound to the nearest degree. (You can set any number you want, but only one decimal place will be displayed at most.)<br><br> **Type:** `Float` <br>**Default value:** `.5`
